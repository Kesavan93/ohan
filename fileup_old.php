	...
	<div class="content">
		...
		<h2>UPLOAD DOCUMENT</h2>
			<form action=""  method="post" enctype="multipart/form-data">
			  ...
			  <input type="file" id="myFile" name="filename1" ><br><br>
...
echo "<br><br><br><a id='nxt' href='search.php?ic=$ic&name=$name'>FINISH REGISTRATION</a>";
